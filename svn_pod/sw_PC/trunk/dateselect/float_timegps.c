/* File: float_timegps.c -- clone and hack of float_time.c for gps data
 * deh 09-18-2012

Note: the 'RM file is the normal input to this routine.  See the scripts
../svn_pod/sw_PC/trunk/dateselect/mmg_xxxxx
 
 */ 
/*
Compile--
gcc float_timegps.c -o float_timegps -lm
Compile & test--
gcc float_timegps.c -o float_timegps -lm && mmg_plotx 120915.165407X
...
void main(int argc, char *argv[])
{
	...
	if(argc != 2)
	{
		fprintf(stderr, "usage: $ float_timegps < <infile> > <outfile>\n");
		exit(EXIT_FAILURE);
	}
