...
*******************************************************************************/
/*
A "hub" routine for CAN msgs.

This routine passes incoming CAN msgs from the CAN hardware, plus each function added,
...
test1 = *pcan1;
	...
	/* The above additions get handled by all the following functions.
	    ...
	    may be needed. */
	something_added = 0;		// Show no local msgs have yet been added.
