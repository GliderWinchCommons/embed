...
-- DMOC receive commands. Unit #1 untranslated
...
-- DMOC receive commands translated 
-- Unit #2
INSERT INTO CANID VALUES ('CANID_DMOC2_CMD_SPEED', '4640001C','MMC',1,1,'I16_X6',         'DMOC2: cmd: speed, key state');
INSERT INTO CANID VALUES ('CANID_DMOC2_CMD_TORQ',  '4660001C','MMC',1,1,'I16_I16_I16_X6', 'DMOC2: cmd: torq,copy,standby,status');
INSERT INTO CANID VALUES ('CANID_DMOC2_CMD_REGEN', '4680001C','MMC',1,1,'I16_I16_X_U8_U8','DMOC2: cmd: watt,accel,degC,alive');
...
INSERT INTO CANID VALUES ('CANID_MC_STATE',          '26000000','MC',1,5,'U8_U8_U8','MC: Launch state msg');
...
INSERT INTO CANID VALUES ('CANID_HB_CPSWSCLV1_5','32000000','CP',      1,1,'U8_U8_U16_U16_S16','HB_CPSWSV1 5:status:spare:sw err:sws on/off:CL +/- 10000');
...
-- BMS module node
-- Universal CAN msg: EMC_I = EMC sends; PC_I = PC sends; R = BMS responds; (EMC = master; EMC1 = string #1; EMC2 = string #2)
...
INSERT INTO CANID VALUES ('CANID_UNI_BMS_EMC1_I','B0000000', 'BMSV1', 1,1,'U8_U8_U8_X4','BMSV1 UNIversal From EMC1, Incoming msg to BMS: X4=target CANID');
INSERT INTO CANID VALUES ('CANID_UNI_BMS_EMC2_I','B0200000', 'BMSV1', 1,1,'U8_U8_U8_X4','BMSV1 UNIversal From EMC2, Incoming msg to BMS: X4=target CANID');
...
INSERT INTO CANID VALUES ('CANID_UNIT_BMS01','B0600000','UNIT_BMS01', 1,1,'BMS_MULTI','BMS BQ76952   #01');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS02','B0800000','UNIT_BMS02', 1,1,'BMS_MULTI','BMS MAX14921  #01');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS03','B0A00000','UNIT_BMS03', 1,1,'BMS_MULTI','BMS ADBMS1818 #01');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS04','B0C00000','UNIT_BMS04', 1,1,'BMS_MULTI','BMS ADBMS1818 #02');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS05','B0E00000','UNIT_BMS05', 1,1,'BMS_MULTI','BMS ADBMS1818 #03');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS06','B1000000','UNIT_BMS06', 1,1,'BMS_MULTI','BMS ADBMS1818 #04');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS07','B1200000','UNIT_BMS07', 1,1,'BMS_MULTI','BMS ADBMS1818 #05');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS08','B1400000','UNIT_BMS08', 1,1,'BMS_MULTI','BMS ADBMS1818 #06');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS09','B1600000','UNIT_BMS09', 1,1,'BMS_MULTI','BMS ADBMS1818 #07');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS10','B1800000','UNIT_BMS10', 1,1,'BMS_MULTI','BMS ADBMS1818 #08');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS11','B1A00000','UNIT_BMS11', 1,1,'BMS_MULTI','BMS ADBMS1818 #09');
-- 'B1C00000' unit ruined. Therefore gap in contiguous numbers
-- But 'B1C00000' shows up in GSM's cangateBMS ta command display, so we add B1C0 back in
INSERT INTO CANID VALUES ('CANID_UNIT_BMS19','B1C00000','UNIT_BMS19', 1,1,'BMS_MULTI','BMS ADBMS1818 #17');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS12','B1E00000','UNIT_BMS12', 1,1,'BMS_MULTI','BMS ADBMS1818 #10');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS13','B2000000','UNIT_BMS13', 1,1,'BMS_MULTI','BMS ADBMS1818 #11');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS14','B2200000','UNIT_BMS14', 1,1,'BMS_MULTI','BMS ADBMS1818 #12');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS15','B2400000','UNIT_BMS15', 1,1,'BMS_MULTI','BMS ADBMS1818 #13');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS16','B2600000','UNIT_BMS16', 1,1,'BMS_MULTI','BMS ADBMS1818 #14');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS17','B2800000','UNIT_BMS17', 1,1,'BMS_MULTI','BMS ADBMS1818 #15');
INSERT INTO CANID VALUES ('CANID_UNIT_BMS18','B2A00000','UNIT_BMS18', 1,1,'BMS_MULTI','BMS ADBMS1818 #16');

-- Nodes/units Loader addresses and also EMC/MMC local nodes send hearbeats, and responses to commands
INSERT INTO CANID VALUES ('CANID_UNIT_EMCMMC1','A0000000','UNIT_ECMCL1', 1,1,'U8_U8_U8_X4','bmsmot 1 EMC/MMC Local1');
INSERT INTO CANID VALUES ('CANID_UNIT_EMCMMC2','A0200000','UNIT_ECMCL2', 1,1,'U8_U8_U8_X4','bmsmot 2 EMC/MMC Local2');
INSERT INTO CANID VALUES ('CANID_UNIT_EMCMMCM','A0400000','UNIT_ECMCM',  1,1,'U8_U8_U8_X4','bmsmot 3 EMC/MMC Master');
INSERT INTO CANID VALUES ('CANID_UNIT_EMCMMCd','A0600000','UNIT_ECMCLd', 1,1,'U8_U8_U8_X4','bmsmot 0 EMC/MMC dEH bench');

-- Commands or data to EMC/MMC local nodes, PC or EMCMMC master sends 
INSERT INTO CANID VALUES ('CANID_CMD_EMCMMC1_PC' ,'A1600000','UNIT_ECM1PC' , 1,1,'U8_U8_U8_X4','bmsmot 1 PC SENDS');
INSERT INTO CANID VALUES ('CANID_CMD_EMCMMC1_EMC','A1800000','UNIT_ECM1EMC', 1,1,'U8_U8_U8_X4','bmsmot 1 EMC SENDS');
INSERT INTO CANID VALUES ('CANID_CMD_EMCMMC2_PC' ,'A1A00000','UNIT_ECM2PC' , 1,1,'U8_U8_U8_X4','bmsmot 2 PC SENDS');
INSERT INTO CANID VALUES ('CANID_CMD_EMCMMC2_EMC','A1E00000','UNIT_ECM2EMC', 1,1,'U8_U8_U8_X4','bmsmot 2 EMC SENDS');

-- PC (HC) sends to EMC
INSERT INTO CANID VALUES ('CANID_CMD_PC_EMC','98000000','UNIT_PC2EMC', 1,1,'U8_U8_U8_X4','PC sends commands to EMC');

-- EMC sends to EMC1, or EMC2
INSERT INTO CANID VALUES ('CANID_CMD_EMC_EMC','98200000','UNIT_EMC2EMC', 1,1,'U8_U8_U8_X4','EMC sends commands to EMC1 or 2');

-- shaft_encoder Mk2 (demo winch) (UNIT: sends readings and CAN loader address; CMD: receives commands from PC, or HC.)
...
-- Expected operational odometer msg
INSERT INTO CANID VALUES ('CANID_MSG1_ENCODER1','83A00000','UNIT_ENCODER', 1,1,'FF_FF' ,'DiscoveryF4 encoder demo winch: lineout, motor speed like edges');
INSERT INTO CANID VALUES ('CANID_MSG1_ENCODER2','83C00000','UNIT_ENCODER', 1,1,'FF_FF' ,'DiscoveryF4 encoder      proxy: lineout, motor speed like edges');
-- Experimental: inertial tests
INSERT INTO CANID VALUES ('CANID_MSG2_ENCODER1','83E00000','UNIT_ENCODER', 1,1,'FF_FF','DiscoveryF4 encoder demo winch: motor accel like edges|motor accel 1/64 cts');
INSERT INTO CANID VALUES ('CANID_MSG2_ENCODER2','84000000','UNIT_ENCODER', 1,1,'FF_FF','DiscoveryF4 encoder      proxy: motor accel like edges|motor accel 1/64 cts');
-- Experimental: inertial tests
INSERT INTO CANID VALUES ('CANID_MSG3_ENCODER1','84200000','UNIT_ENCODER', 1,1,'FF_S32','DiscoveryF4 encoder demo winch: motor speed 1/64 cts|encoder counter');
INSERT INTO CANID VALUES ('CANID_MSG3_ENCODER2','84400000','UNIT_ENCODER', 1,1,'FF_S32','DiscoveryF4 encoder      proxy: motor speed 1/64 cts|encoder counter');
...
INSERT INTO CANID VALUES ('CANID_FILTER' ,'07000000','UNIT_XX',1,1,'U8','hub-server sandbox CAN filter management');
...
-- These are translated ELCON.
-- Unit #2
INSERT INTO CANID VALUES ('CANID_ELCON2_TX','C7FA873C','ELCON1',1,1,'I16_I16_U8_U8_U8_U8','ELCON2 Translated Charger transmit: ');
INSERT INTO CANID VALUES ('CANID_ELCON2_RX','C0372FB4','ELCON1',1,1,'I16_I16_U8_U8_U8_U8','ELCON2 Translated Charger receive: ');
