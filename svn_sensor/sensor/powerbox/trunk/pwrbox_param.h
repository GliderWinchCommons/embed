/******************************************************************************
* File Name          : pwrbox_param.h
* Date First Issued  : 04/08/2015,06/13/2018
* Board              : f103
* Description        : Initialize tension function struct with default values
*******************************************************************************/
#ifndef __PWRBOX_PARAM_Q
#define __PWRBOX_PARAM_Q
...
/* **************************************************************************************/
void pwrbox_param_default_init(struct TENSIONLC* pten); 
/* @brief	: Initialize struct with default values
 * ************************************************************************************** */
void* pwrbox_param_lookup_ptr(u32 id_num);
