...
//	UART4_rxinttxint_initRTC(38400,96,2,48,4);	//  (@5) 5 Hz on-board GPS baud 
	...
	// Garmin connects to UART4 (rx only)
	cGPStype = GARMIN_18X_5_HZ;

	// u-blox connects to UART5 (tx, rx)
//	UART5_rxinttxint_initRTC(38400,GPSUARTLINEBUFSIZE+6,2,32,2);
//	cGPStype = UBLOX_NEO_6M;	// Code for dealing with sentences


	/* Announce who we are */
	// $Revision: 853 $ This is updated automatically by SVN 
	USART1_txint_puts("\n\rpod_v2b_r0.0  rev >786 \n\r"); USART1_txint_send();
