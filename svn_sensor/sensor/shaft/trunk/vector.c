...
//#include "se4_h.h"	// IAMUNITNUMBER definition
...
void WEAK I2C1_ER_IRQHandler(void);	// i2c1_er_isr(void);
...
//	main,			/* Use main() as reset vector for now. */
	...
	I2C1_ER_IRQHandler,	//i2c1_er_isr,
...
#pragma weak DMA1CH1_IRQHandler = null_handler
#pragma weak DMA1CH2_IRQHandler = null_handler
...
#pragma weak I2C1_ER_IRQHandler = null_handler
