...
volatile unsigned int	uiRTCsystemcounterTim2IC;	// Save RTC count upon each Tim2 IC
...
void TIM2_IRQHandler(void)
{
	...
	case 0x01:	// Overflow flag only
			...
			temp = TIM2_SR;				// Readback register bit to be sure is cleared
			break;
	...
	case 0x04:	// Catpure flag only
			uiRTCsystemcounterTim2IC = uiRTCsystemcounter; // SAVE current RTC_CNT count
