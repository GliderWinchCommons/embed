...
fmtprint(i+ 4, ppwr->adc[0].offset*10000, " 4 ADC 0 offset*10000 5V");
fmtprint(i+ 5, ppwr->adc[0].scale*10000,  " 5 ADC 0 scale*10000  5V");
fmtprint(i+ 6, ppwr->adc[1].offset*10000, " 6 ADC 1 offset*10000 CAN V");
fmtprint(i+ 7, ppwr->adc[1].scale*10000,  " 7 ADC 1 scale*10000  CAN V");
fmtprint(i+ 8, ppwr->adc[2].offset*10000, " 8 ADC 2 offset*10000 Diode V");
fmtprint(i+ 9, ppwr->adc[2].scale*10000,  " 9 ADC 2 scale*10000  Diode V");
fmtprint(i+10, ppwr->adc[3].offset*10000, "10 ADC 3 offset*10000 In Pwr");
fmtprint(i+11, ppwr->adc[3].scale*10000,  "11 ADC 3 scale*10000  In Pwr");
fmtprint(i+12, ppwr->adc[4].offset,       "12 ADC 4 offset       Hall-effect");
fmtprint(i+13, ppwr->adc[4].scale,        "13 ADC 4 scale        Hall-effect");
fmtprint(i+14, ppwr->adc[5].offset,       "14 ADC 5 offset:      spare");
fmtprint(i+15, ppwr->adc[5].scale,        "15 ADC 5 scale:       spare");
fmtprint(i+16, ppwr->adc[6].offset*10000, "16 ADC 6 offset*10000 I temp");
fmtprint(i+17, ppwr->adc[6].scale*10000,  "17 ADC 6 scale*10000  I temp");
fmtprint(i+18, ppwr->adc[7].offset*10000, "18 ADC 7 offset*10000 Vref ");
fmtprint(i+19, ppwr->adc[7].scale*10000,  "19 ADC 7 scale*10000  Vref");
...
printf("%2d	%d	%s\n\r",i+31, (unsigned int)ppwr->alarmct,  "31 Time between alarm msgs (ms)");
