...
p->code_CAN_filt[0] = ptbl[PWRBOX_CANID_HW_FILT1];		 /* 33 Tension: CAN ID 1 for setting up CAN hardware filter */
p->code_CAN_filt[1] = ptbl[PWRBOX_CANID_HW_FILT2];		 /* 34 Tension: CAN ID 2 for setting up CAN hardware filter */
p->code_CAN_filt[2] = ptbl[PWRBOX_CANID_HW_FILT3];		 /* 35 Tension: CAN ID 3 for setting up CAN hardware filter */
p->code_CAN_filt[3] = ptbl[PWRBOX_CANID_HW_FILT4];		 /* 36 Tension: CAN ID 4 for setting up CAN hardware filter */
p->code_CAN_filt[4] = ptbl[PWRBOX_CANID_HW_FILT5];		 /* 37 Tension: CAN ID 5 for setting up CAN hardware filter */
p->code_CAN_filt[5] = ptbl[PWRBOX_CANID_HW_FILT6];		 /* 38 Tension: CAN ID 6 for setting up CAN hardware filter */
p->code_CAN_filt[6] = ptbl[PWRBOX_CANID_HW_FILT7];		 /* 39 Tension: CAN ID 7 for setting up CAN hardware filter */
p->code_CAN_filt[7] = ptbl[PWRBOX_CANID_HW_FILT8];		 /* 40 Tension: CAN ID 8 for setting up CAN hardware filter */

p->cid_lvl_msg   = ptbl[PWRBOX_LVL_MSG_R];    /* 41 CANID-level wind motor current: msg       */
p->cid_lvl_hb    = ptbl[PWRBOX_LVL_HB_R];     /* 42 CANID-level wind motor current: heartbeat */
