...
printf("%2d	0x%08X	%s\n\r",i+44, (unsigned int)p->code_CAN_filt[0], " 13 Shaft: CANID 1 for setting up CAN hardware filter");
printf("%2d	0x%08X	%s\n\r",i+45, (unsigned int)p->code_CAN_filt[1], " 14 Shaft: CANID 2 for setting up CAN hardware filter");
printf("%2d	0x%08X	%s\n\r",i+46, (unsigned int)p->code_CAN_filt[2], " 15 Shaft: CANID 3 for setting up CAN hardware filter");
printf("%2d	0x%08X	%s\n\r",i+47, (unsigned int)p->code_CAN_filt[3], " 16 Shaft: CANID 4 for setting up CAN hardware filter");
printf("%2d	0x%08X	%s\n\r",i+48, (unsigned int)p->code_CAN_filt[4], " 17 Shaft: CANID 5 for setting up CAN hardware filter");
printf("%2d	0x%08X	%s\n\r",i+49, (unsigned int)p->code_CAN_filt[5], " 18 Shaft: CANID 6 for setting up CAN hardware filter");
printf("%2d	0x%08X	%s\n\r",i+50, (unsigned int)p->code_CAN_filt[6], " 19 Shaft: CANID 7 for setting up CAN hardware filter");
printf("%2d	0x%08X	%s\n\r",i+51, (unsigned int)p->code_CAN_filt[7], " 20 Shaft: CANID 8 for setting up CAN hardware filter");
