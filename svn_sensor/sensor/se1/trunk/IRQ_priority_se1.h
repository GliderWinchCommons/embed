...
#define TIM4_PRIORITY_SE1              0x70	//   RPM input capture & timing
...
#define DMA1_CH1_PRIORITY_SE1            0x05  // DMA 1/2 and end of buffer interrupt for adc
